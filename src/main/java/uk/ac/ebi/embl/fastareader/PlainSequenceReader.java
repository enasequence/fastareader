...
public class PlainSequenceReader implements AutoCloseable {
    ...
    @Getter
    private SequenceStats sequenceEntry;
     ...
     * */
    public PlainSequenceReader(File sequenceFile, SequenceAlphabet alphabet) throws SequenceFileException, IOException {
        this.file = Objects.requireNonNull(sequenceFile, "sequenceFile");
        checkIfUtf8(file);

        resetData();
        this.alphabet = alphabet;
        this.reader = new InternalReader(sequenceFile, this.alphabet, SequenceFileFormat.PLAIN_SEQUENCE);
    ...
    public void openNewFile(File sequenceFile) throws SequenceFileException, IOException {
        ...
        reader = new InternalReader(sequenceFile, this.alphabet, SequenceFileFormat.PLAIN_SEQUENCE);
    ...
    private void loadSequence() throws IOException, SequenceFileException {
        ...
        sequenceEntry = new SequenceStats(
